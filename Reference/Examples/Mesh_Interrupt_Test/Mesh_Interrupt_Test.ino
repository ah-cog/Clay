...
const short role_pin = 7;                 // sets the role of this unit in hardware.  Connect to GND to be the 'pong' receiver
...
void setup(){
  ...
  int IRQ_PIN = 0;
  pinMode(IRQ_PIN, INPUT); // Set the digital pin as input
  attachInterrupt(IRQ_PIN, check_radio, FALLING); // attachInterrupt(IRQ_PIN, check_radio, LOW);
