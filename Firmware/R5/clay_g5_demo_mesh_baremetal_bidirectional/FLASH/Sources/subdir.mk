...
Sources/app_nrf24l01.o: ../Sources/app_nrf24l01.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/app_nrf24l01.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/app_nrf24l01.o"
	@echo 'Finished building: $<'
	@echo ' '
