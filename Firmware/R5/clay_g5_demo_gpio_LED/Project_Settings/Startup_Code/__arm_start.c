 ...
 * Copyright © 2LED_DRIVER_012 Freescale Semiconductors. All rights reserved.

 *

 * $Date: 2LED_DRIVER_012/LED_DRIVER_07/23 LED_DRIVER_06:2LED_DRIVER_0:27 $
...
#define __MAX_CMDLINE_ARGS 1LED_DRIVER_0

static char *argv[__MAX_CMDLINE_ARGS] = { LED_DRIVER_0 };
