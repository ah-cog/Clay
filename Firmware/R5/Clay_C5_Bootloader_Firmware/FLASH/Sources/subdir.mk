...
Sources/Behavior.o: ../Sources/Behavior.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/Behavior.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/Behavior.o"
	@echo 'Finished building: $<'
	@echo ' '
...
Sources/Events_ESP8266.o: ../Sources/Events_ESP8266.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/Events_ESP8266.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/Events_ESP8266.o"
	@echo 'Finished building: $<'
	@echo ' '
