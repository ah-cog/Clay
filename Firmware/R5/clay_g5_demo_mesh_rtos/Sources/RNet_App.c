...
static uint8_t RNETA_HandleRxMessage(RAPP_MSG_Type type, uint8_t size, uint8_t *data, RNWK_ShortAddrType srcAddr, bool *handled,
        RPHY_PacketDesc *packet)
{
    ...
    case RAPP_MSG_TYPE_PING: /* <type><size><data */
        *handled = TRUE;
        ...
        LED2_PutVal(LED2_DeviceData, 0);
        FRTOS1_vTaskDelay(20/portTICK_RATE_MS);
        LED2_PutVal(LED2_DeviceData, 1);
        return ERR_OK;
    default:
        break;
    } /* switch */
