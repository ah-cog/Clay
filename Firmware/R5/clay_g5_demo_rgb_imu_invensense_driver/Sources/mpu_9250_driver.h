...
extern uint8_t write_mpu9250(uint8_t device_addr, uint8_t reg_addr, uint8_t length, uint8_t * data);
extern uint8_t read_mpu9250(uint8_t device_addr, uint8_t reg_addr, uint8_t length, uint8_t * data);

#endif /* MPU_9250_DRIVER_H_ */
