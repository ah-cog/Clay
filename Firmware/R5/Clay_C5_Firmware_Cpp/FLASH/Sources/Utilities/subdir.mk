...
Sources/Utilities/Debug.o: ../Sources/Utilities/Debug.c
	...
	"$(ARMSourceryDirEnv)/arm-none-eabi-g++" "$<" @"Sources/Utilities/Debug.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/Utilities/Debug.o"
...
Sources/Utilities/Ring_Buffer.o: ../Sources/Utilities/Ring_Buffer.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C++ Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-g++" "$<" @"Sources/Utilities/Ring_Buffer.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/Utilities/Ring_Buffer.o"
	@echo 'Finished building: $<'
	@echo ' '
...
Sources/Utilities/String.o: ../Sources/Utilities/String.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C++ Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-g++" "$<" @"Sources/Utilities/String.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/Utilities/String.o"
	@echo 'Finished building: $<'
	@echo ' '
...
Sources/Utilities/UUID.o: ../Sources/Utilities/UUID.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C++ Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-g++" "$<" @"Sources/Utilities/UUID.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/Utilities/UUID.o"
	@echo 'Finished building: $<'
	@echo ' '
