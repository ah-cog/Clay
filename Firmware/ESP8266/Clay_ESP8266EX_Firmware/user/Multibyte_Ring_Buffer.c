...
//{
//
//	uint32_t rval = Multibyte_Ring_Buffer_Get_Bytes_Before_Char(buffer,
//			end_char);
//
//	if (rval > 0 && rval <= size)
//	{
...
//uint32_t Multibyte_Ring_Buffer_Get_Bytes_Before_Char(
//		Multibyte_Ring_Buffer * buffer, char end_char)
//{
//
//	uint32_t bytes_after_head = (
//			buffer->head < buffer->tail ?
...
//	uint32_t rval = 0;
//
//	uint8_t * char_location = memchr(BUFFER_HEAD(buffer), end_char,
//			bytes_after_head);
//
...
uint32_t Multibyte_Ring_Buffer_Dequeue_Serialized_Message(
		...
		else
		{
			...
			else
			{
						...
						++i)
				{
					...
					message_checksum = (message_checksum * 10)
							+ (*(buffer->data
									+ (i + buffer->head) % buffer->max_count)
									- 0x30);
				}
...
//	char * test_msg_content =
//			"mmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmm!!mmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemmmmmeeeeemm512"; //512 chars
//
...
//	Serialize_Message_With_Message_Header(test_msg, test_msg_str,
//			test_msg_str_len);
//
//	uint8_t * serial_data;
//	uint32_t dq_count = 0;
...
//		while (!Multibyte_Ring_Buffer_Full(&test_buffer))
//		{
//			Multibyte_Ring_Buffer_Enqueue(&test_buffer, test_msg_str,
//					strlen(test_msg_str));
//		}
//
//		while ((dq_count = Multibyte_Ring_Buffer_Dequeue_Serialized_Message(
//				&test_buffer, &serial_data)) > 0)
//		{
//			if (serial_data != NULL)
//			{
//				deserialized_message = Deserialize_Message_With_Message_Header(
//						serial_data);
//				Serialize_Message_Content(deserialized_message, serial_data,
//						dq_count);
