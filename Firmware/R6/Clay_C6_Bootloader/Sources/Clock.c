...
Color_RGB colors[] = {
	...
	{ LED_MODE_MED, LED_MODE_OFF, LED_MODE_MED }, // R B
	
	{ LED_MODE_LOW, LED_MODE_OFF, LED_MODE_OFF }, // Red (Low)
	{ LED_MODE_OFF, LED_MODE_LOW, LED_MODE_OFF }, // Green (Low)
	{ LED_MODE_OFF, LED_MODE_OFF, LED_MODE_LOW }, // Blue (Low)
	
	{ LED_MODE_MED, LED_MODE_OFF, LED_MODE_OFF }, // Red (Medium)
	{ LED_MODE_OFF, LED_MODE_MED, LED_MODE_OFF }, // Green (Medium)
	{ LED_MODE_OFF, LED_MODE_OFF, LED_MODE_MED }, // Blue (Medium)
	
	{ LED_MODE_MAX, LED_MODE_OFF, LED_MODE_OFF }, // Red (Max)
	{ LED_MODE_OFF, LED_MODE_MAX, LED_MODE_OFF }, // Green (Max)
	{ LED_MODE_OFF, LED_MODE_OFF, LED_MODE_MAX }, // Blue (Max)
	
	{ LED_MODE_LOW, LED_MODE_LOW, LED_MODE_LOW }, // White (Low)
	{ LED_MODE_MED, LED_MODE_MED, LED_MODE_MED }, // White (Medium)
	{ LED_MODE_MAX, LED_MODE_MAX, LED_MODE_MAX }  // White (Max)
};
