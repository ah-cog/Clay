...
//	char *key;
//	void *propagate; // function pointer to "propagate" function
//} Propagator;
...
extern Observable_Set* Create_Observable_Set ();
...
//extern void Add_Observable (const char *key, Observable observable); // ...adds to Observable_List
//extern void Get_Observable_Data (Observable *observable);
//extern void Add_Propagator (Observable_Set ol, Observable o, const char *key, Observable_Set ol2, Observable o2, const char *key2); // Use to move data from one object to another dependent object
////extern void Add_Custom_Propagator (Observable o, const char *key, void *function); // Use to propagate data to control actual hardware, or to package as a message for transmission
//extern void Remove_Propagator(Observable *observable, Propagator *propagator);
//extern void Delete_Propagator(Propagator *propagator);
//extern void Remove_Observable(Observable_Set *observable_set, Observable *observable);
...
typedef struct Observable_Device {
	...
	*/
	...
	// Observers
	Observable_Set *observable_set; // TODO: Replace toggle_value, waveform_sample_value, and pulse_* variables with an observable
