...
//      }
//
//      updated_channel_profile[CHANNEL_4].data->pulse_duty_cycle = channel_ratio;
//
//      Apply_Channels();
//
...
//
//      color_set = channel_profile[CHANNEL_6].data->waveform_sample_value * (scale_mv_up ? scale_factor : 1);
//
