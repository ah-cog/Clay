...
bool RH_NRF24::setRF(DataRate data_rate, TransmitPower power) {
   ...
   else if (data_rate == DataRate2Mbps) value |= RH_NRF24_RF_DR_HIGH;
...
bool RH_NRF24::isSending() {
   return !(spiReadRegister(RH_NRF24_REG_00_CONFIG) & RH_NRF24_PRIM_RX) && !(statusRead() & (RH_NRF24_TX_DS | RH_NRF24_MAX_RT));
}
